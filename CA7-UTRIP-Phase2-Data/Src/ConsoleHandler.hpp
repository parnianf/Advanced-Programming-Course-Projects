...
private:
    ...
    void logout();
    void postSort(std::stringstream& data);
    ...
    void applyDefaultFilter(std::stringstream& data);
    void postManualWeight(std::stringstream& data);
    void doPostOrders(std::string command,std::stringstream& data);
    void getManualWeight();
    void showEstimatedWeight(std::stringstream& data);
